...
Welcome to `python_libs` contributor's guide.
...
If you experience bugs or general issues with `python_libs`, please have a look
...
You can help improve `python_libs` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`python_libs` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `python_libs`'s files. While this mechanism can
...
```
conda create -n python_libs python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/python_libs.git
   cd python_libs
   ```
...
5. Install [pre-commit]:
   ...
   `python_libs` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/python_libs
[issue tracker]: https://github.com/<USERNAME>/python_libs/issues
